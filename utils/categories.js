const categories = [
  {
    ...
    parent: 'Headphones',
    children: ['Kids Headphones', 'Bluetooth Headphones', 'On-Ear Headphones'],
  ...
  },
  {
    ...
    children: ['CPU Cooler', 'Air CPU Cooler'],
    productType: 'electronics',
  ...
  },
  {
    ...
    parent: 'Smart Watch',
    children: ['Sports Smart Watch', 'Apple Watch', 'Fitness Smart Watch'],
    productType: 'electronics',
    products: [
  ...
  },
  {
    ...
    parent: 'Bluetooth',
    children: ['Wireless Bluetooth', 'Sports Bluetooth'],
    productType: 'electronics',
  ...
  },
  {
    ...
    parent: 'Bags',
    children: ['HandBag', 'Traveling Bag'],
    productType: 'fashion',
